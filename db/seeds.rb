...
user1 = User.create({username: 'Alexander_Marks-Katz', password: 'demoUser',
  ...
  cover_photo: 'https://scontent.fsnc1-1.fna.fbcdn.net/v/t1.0-9/17523368_1372208939516369_1155114120450250589_n.jpg?oh=e752d1c59ae8729b640909a442d113c1&oe=5A9E763C',
  custom_link: 'https://www.linkedin.com/in/alexander-marks-katz-78a09a20/'})
user2 = User.create({username: 'newUser', password: '12345678'})
